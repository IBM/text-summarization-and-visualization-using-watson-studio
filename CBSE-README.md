...
**Usecase** :- Text summarization and visualization using watson studio
...
* Understand what is NLP and the common terms associated with it
* How to preprocess unstructured data for further analysis
